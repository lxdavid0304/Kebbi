...
interface IFaceControlService {
    ...
    void playTTSmotion(String speakString, String fstName, String animName, int emotionType, int motionMode, int faceMode); // isMotionMode 0:ramdon 1:specific 2:withEmotion
    void pauseTTSmotion();
    void resumeTTSmotion();
    void showMedia(String type,String uri,String speak,IonCompleteListener listener);
}
